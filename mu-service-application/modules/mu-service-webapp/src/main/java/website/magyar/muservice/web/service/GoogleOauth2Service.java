...
public class GoogleOauth2Service extends Oauth2ServiceBase {
    ...
    private static final String SUBJECT = "[MuService] - New Google Social";
    ...
    @Autowired
    private AppCustomAuthenticationProvider adorationAppCustomAuthenticationProvider;
    @Autowired
    ...
    public Authentication getGoogleUserInfoJson(final String authCode) {
        ...
        try {
            ...
            authentication = adorationAppCustomAuthenticationProvider.authenticate(new PreAuthenticatedAuthenticationToken(googleUser, credential));
        } catch (Exception ex) {
    ...
    private Social detectSocial(GoogleUserInfoJson googleUserInfoJson) {
        ...
        if (social == null) {
            ...
            id = businessWithSocial.newSocial(social);
    ...
    private void autoUpdateGoogleSocial(Social social, String name, String email, String picture) {
        ...
        if (wasUpdate) {
            businessWithSocial.updateSocial(social);
        }
    }
