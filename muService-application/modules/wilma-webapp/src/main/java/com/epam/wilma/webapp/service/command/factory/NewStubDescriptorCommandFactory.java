...
public class NewStubDescriptorCommandFactory {
     ...
     */
    public StubDescriptorModificationCommand create(final String filePath, final ConfigurationDescriptorJsonFactory stubConfigurationJsonBuilder) throws FileNotFoundException {
        InputStream inputStream = fileInputStreamFactory.createFileInputStream(filePath);
        return create(inputStream, stubConfigurationJsonBuilder);
    }
     ...
     * @return the new instance
     */
    public StubDescriptorModificationCommand create(final InputStream inputStream, final ConfigurationDescriptorJsonFactory stubConfigurationJsonBuilder) {
        return new NewStubDescriptorCommand(inputStream, stubConfigurationJsonBuilder);
    }
}
