package website.magyar.muservice.web;
...
import website.magyar.muservice.web.service.ServerException;
...
public class WebAppServer {
    ...
    private WebAppContext configureWebAppContext() {
        ...
        errorHandler.addErrorPage(HttpStatus.NOT_FOUND.value(), "/e404");
        errorHandler.addErrorPage(HttpStatus.INTERNAL_SERVER_ERROR.value(), "/e500");
