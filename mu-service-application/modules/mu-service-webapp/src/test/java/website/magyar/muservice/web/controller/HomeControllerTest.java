...
import website.magyar.muservice.web.configuration.PropertyDto;
import website.magyar.muservice.web.configuration.WebAppConfigurationAccess;
import website.magyar.muservice.web.helper.MockControllerBase;
...
public class HomeControllerTest {
    ...
    public void getLoggedInUserInfo() {
        ...
        doReturn(new PropertyDto(null, null, null, null, null,
                null)).when(webAppConfigurationAccess).getProperties();
        //when
