...
public class NewStubDescriptorCommandFactory {
     ...
     */
    public StubDescriptorModificationCommand create(final String filePath, final StubDescriptorJsonFactory stubConfigurationJsonBuilder) throws FileNotFoundException {
